...
{
    private static SpawnCardManager _instance;
    ...
    public static SpawnCardManager Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<SpawnCardManager>();
                if (_instance == null)
                {
                    GameObject go = new GameObject("SpawnCardManager");
                    _instance = go.AddComponent<SpawnCardManager>();
                }
            }
            return _instance;
        }
