using RogueLikeGameMode.Components;
using System;
...
namespace RogueLikeGameMode
{
    public class RogueLike : ISrPlugin
    {
        ...
        {
            Debug.Log("Initializing Satellite Reign RogueLike mod");
        ...
        public void Update()
        {
            ...
            if (Manager.Get().GameInProgress)
            {
                ...
                {
                    StopSaves();
                    Manager.GetUIManager().DoModalMessageBox("Going rogue!", "RogueLike Gamemode Mod is active. Beware that this mod deletes your savegames if an agent dies, removes the agent and then autosaves. Good luck and have fun", InputBoxUi.InputBoxTypes.MbOk);
                    shownModInfo = true;
                }
